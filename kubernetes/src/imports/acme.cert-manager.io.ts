...
export interface ChallengeSpecSolverHttp01GatewayHttpRoutePodTemplateSpec {
	...
	/**
	 * If specified, the pod's security asyncContext
	 *
...
export interface ChallengeSpecSolverHttp01GatewayHttpRoutePodTemplateSpecSecurityContext {
	...
	/**
	 * The SELinux asyncContext to be applied to all containers.
	 * If unspecified, the container runtime will allocate a random SELinux asyncContext for each
