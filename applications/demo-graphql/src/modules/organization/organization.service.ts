...
import { ConflictError, NotImplementedError } from '@mxvincent/errors'
...
export class OrganizationService {
	...
	async getConnection(options: QueryParameters): Promise<GQLConnection<Organization>> {
	...
	async getMembersConnection(options: QueryParameters): Promise<GQLConnection<OrganizationMember>> {
