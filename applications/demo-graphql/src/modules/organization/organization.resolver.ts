...
import { GQLPagination } from '@app/schemas/pagination.schema'
...
import { Equal, GQLConnection, Pagination, QueryParameters, Sort } from '@mxvincent/query-params'
...
export class OrganizationResolver {
	...
	async members(
		...
		const options = new QueryParameters({
			...
			filters: [Equal('organizationId', organization.id)]
		})
